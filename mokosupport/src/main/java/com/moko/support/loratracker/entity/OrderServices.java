package com.moko.support.loratracker.entity;
...
public enum OrderServices {
    ...
    SERVICE_DEVICE_BATTERY(UUID.fromString("0000180F-0000-1000-8000-00805F9B34FB")),
    SERVICE_CUSTOM(UUID.fromString("0000AA00-0000-1000-8000-00805F9B34FB")),
    SERVICE_ADV(UUID.fromString("0000AA01-0000-1000-8000-00805F9B34FB")),
    ;
    private UUID uuid;
