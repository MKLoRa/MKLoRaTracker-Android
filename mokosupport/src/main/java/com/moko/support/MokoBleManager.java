...
public class MokoBleManager extends BleManager {
    ...
    private final static UUID PASSWORD_UUID = UUID.fromString("0000ff00-0000-1000-8000-00805F9B34FB");
    private final static UUID DISCONNECTED_UUID = UUID.fromString("0000ff01-0000-1000-8000-00805F9B34FB");
    private final static UUID PARAMS_CONFIG_UUID = UUID.fromString("0000ff02-0000-1000-8000-00805F9B34FB");
