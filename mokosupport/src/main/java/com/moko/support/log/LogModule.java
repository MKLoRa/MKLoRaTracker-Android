...
public class LogModule {
    private static final String TAG = "LoRaTracker_V2";
    private static final String LOG_FOLDER = "LoRaTracker_V2";
    private static final String LOG_FILE = "LoRaTracker_V2.txt";
