...
public class FilterCTOptionsActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvTitle.setText("Contact Tracking Filter Options");
        tvConditionATitle.setText("Contact Tracking Filter Condition A");
        tvConditionBTitle.setText("Contact Tracking Filter Condition B");
        ...
        if (!LoRaTrackerMokoSupport.getInstance().isBluetoothOpen()) {
            ...
            orderTasks.add(OrderTaskAssembler.getCTFilterRepeat());
                            ...
                            if (flag == 0x01) {
                                ...
                                switch (configKeyEnum) {
                                    ...
                                    case KEY_TRACKING_FILTER_A_B_RELATION:
                                        ...
                                        if (savedParamsError) {
                                            ToastUtils.showToast(FilterCTOptionsActivity.this, "Opps！Save failed. Please check the input characters and try again.");
                                        } else {
                ...
                if (BluetoothAdapter.ACTION_STATE_CHANGED.equals(action)) {
                    ...
                    switch (blueState) {
                        case BluetoothAdapter.STATE_TURNING_OFF:
                            dismissSyncProgressDialog();
                            FilterCTOptionsActivity.this.setResult(RESULT_OK);
                            finish();
                            break;
                    }
                }
    ...
    public void onRelation(View view) {
        ...
        dialog.setListener(value -> {
            ...
            mSelected = value;
            showSyncingProgressDialog();
            LoRaTrackerMokoSupport.getInstance().sendOrder(OrderTaskAssembler.setCTFilterABRelation(value));
        });
        dialog.show(getSupportFragmentManager());
    }
    ...
    public void onRepeat(View view) {
        ...
        dialog.setListener(value -> {
            ...
            showSyncingProgressDialog();
            LoRaTrackerMokoSupport.getInstance().sendOrder(OrderTaskAssembler.setCTFilterRepeat(value));
        });
        dialog.show(getSupportFragmentManager());
    }
